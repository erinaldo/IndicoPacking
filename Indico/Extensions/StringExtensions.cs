...
namespace IndicoPacking.Extensions
{
    /// <summary>
    ...
    public static class StringExtensions
    {
        ...
        public static string RemoveChar(this string str, params char[] characters)
        {
            ...
            return characters.Length <= 0 ? str : 
        ...
        /// <summary>
        /// Check the string is NOT (null||empty||only contains white spaces)
        /// </summary>
        /// <param name="str">string to check</param>
        /// <returns>result (true/false)</returns>
        public static bool IsUseful(this string str)
        {
